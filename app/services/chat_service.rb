class ChatService
  ...
  private
    ...
    def models
      {"object"=>"list",
      "data"=>
        [{"id"=>"gpt-4o-audio-preview-2024-10-01", "object"=>"model", "created"=>1727389042, "owned_by"=>"system"},
        {"id"=>"gpt-4o-mini-audio-preview", "object"=>"model", "created"=>1734387424, "owned_by"=>"system"},
        {"id"=>"gpt-4o-realtime-preview-2024-10-01", "object"=>"model", "created"=>1727131766, "owned_by"=>"system"},
        {"id"=>"gpt-4o-mini-audio-preview-2024-12-17", "object"=>"model", "created"=>1734115920, "owned_by"=>"system"},
        {"id"=>"gpt-4o-mini-realtime-preview", "object"=>"model", "created"=>1734387380, "owned_by"=>"system"},
        {"id"=>"dall-e-2", "object"=>"model", "created"=>1698798177, "owned_by"=>"system"},
        {"id"=>"gpt-4-1106-preview", "object"=>"model", "created"=>1698957206, "owned_by"=>"system"},
        {"id"=>"gpt-4o-realtime-preview-2024-12-17", "object"=>"model", "created"=>1733945430, "owned_by"=>"system"},
        ...
        {"id"=>"gpt-4-turbo-2024-04-09", "object"=>"model", "created"=>1712601677, "owned_by"=>"system"},
        ...
        {"id"=>"gpt-4-turbo-preview", "object"=>"model", "created"=>1706037777, "owned_by"=>"system"},
        {"id"=>"gpt-4o-mini-realtime-preview-2024-12-17", "object"=>"model", "created"=>1734112601, "owned_by"=>"system"}
        ...
        {"id"=>"gpt-4o-2024-11-20", "object"=>"model", "created"=>1731975040, "owned_by"=>"system"},
        ...
        {"id"=>"gpt-4o-audio-preview-2024-12-17", "object"=>"model", "created"=>1734034239, "owned_by"=>"system"},
